...
export function registerCommands(ctx: VyapakaExtensionContext): void {
  ...
  // Focus Dashboard command (internal)
  subscriptions.push(
    vscode.commands.registerCommand('vyapaka.dashboard.focus', () => {
      // This will focus the webview if it's open
      vscode.commands.executeCommand('workbench.view.extension.vyapaka');
    })
  );
}